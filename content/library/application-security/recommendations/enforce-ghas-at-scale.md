...
1. **Security Configurations** - Security Configurations provide an easy way to enforce [Code Scanning Default Setup](https://docs.github.com/enterprise-cloud@latest/code-security/how-tos/find-and-fix-code-vulnerabilities/configure-code-scanning/configure-code-scanning), which leverages [CodeQL](https://codeql.github.com/).
