...
1. A [bash script](https://docs.github.com/enterprise-cloud@latest/admin/configuring-settings/configuring-private-networking-for-hosted-compute-products/configuring-private-networking-for-github-hosted-runners-in-your-enterprise#2-use-a-script-to-configure-your-azure-resources)
...
1. Using [terraform](https://developer.hashicorp.com/terraform) instead of `bicep`/`az` CLI. Below we will discuss using an open source GitHub terraform module, created by GitHub engineers, to deploy the resources.
