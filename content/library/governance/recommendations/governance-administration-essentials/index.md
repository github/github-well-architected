...
![GHEC structural layers: enterprise account, enterprise teams, organizations, repositories, and teams](enterprise-account-overview.png)
...
![Model 1: Single organization](enterprise-account-model-1.png)
...
![Enterprise account: Red-green-sandbox-archive model](enterprise-account-model-2.png)
...
![Model 3: Portfolio company](enterprise-account-model-3.png)
